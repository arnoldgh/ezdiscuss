...
namespace EZDiscuss
{
    public partial class MemberTopicMessages : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            Session["CurrentPage"] = "MemberTopicMessages.aspx";

            if (Request.QueryString["MemberId"] != null)
            {
                long memberId = Convert.ToInt64(Request.QueryString["MemberId"].ToString());
                long topicId = Convert.ToInt64(Request.QueryString["TopicId"].ToString());
                //long topicId = 1;
